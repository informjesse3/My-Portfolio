  ...
  return (
    <div>
      <AiOutlineMenu
        color="#000"
        onClick={handleNav}
        className="absolute top-4 right-4 z-[50] md:hidden text-[#000] cursor-pointer"
      />
      {nav ? (
      ...
      <div className="md:block hidden  z-[1000] bg-white">
        <div className="flex flex-row justify-end z-[1000]">
          <NavLink
            to="/"
            className="rounded-full z-[1000] shadow-lg  m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300"
          >
